...
if re.search("alex", dane[4]):
    pyautogui.press("down", presses=3)
elif re.search("gloria", dane[4]):
    pyautogui.press("down", presses=4)
elif re.search("liwia", dane[4]):
    pyautogui.press("down", presses=5)
elif re.search("max", dane[4]):
    pyautogui.press("down", presses=6)
elif re.search("maxima", dane[4]):
    pyautogui.press("down", presses=7)
elif re.search("mona", dane[4]):
    pyautogui.press("down", presses=8)
elif re.search("olimpia", dane[4]):
    pyautogui.press("down", presses=9)
elif re.search("oskar", dane[4]):
    pyautogui.press("down", presses=10)
elif re.search("petra", dane[4]):
    pyautogui.press("down", presses=11)

pyautogui.press("Enter", presses=1)  # exit list

pyautogui.click(1884, 270)  # save product
